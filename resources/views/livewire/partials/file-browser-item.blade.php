...
<div style="padding-left: {{ $paddingLeft }}rem;">
    @if($item['isDir'])
        <button
            ...
            class="flex w-full items-center gap-2 rounded px-2 py-1 text-left text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 bg-transparent border-none cursor-pointer"
        >
    ...
    @else
        <button
            ...
            class="flex w-full items-center gap-2 rounded px-2 py-1 text-left text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 bg-transparent border-none cursor-pointer"
        >
            <svg width="16" height="16" class="shrink-0 text-gray-400 dark:text-gray-500" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
