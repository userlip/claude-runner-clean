...
<div class="file-browser-tree-node" style="--file-depth: {{ $paddingLeft }};">
    @if($item['isDir'])
        <button
        ...
        >
            @if($this->isExpanded($item['path']))
                <svg width="16" height="16" class="file-browser-icon-dir" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
    ...
    @else
        <button
            ...
            class="file-browser-item"
        >
            <svg width="16" height="16" class="file-browser-icon-file" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
