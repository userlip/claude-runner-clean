...
<div style="padding-left: {{ $paddingLeft }}rem;">
    @if($item['isDir'])
        ...
        >
            @if($this->isExpanded($item['path']))
                <svg width="16" height="16" style="color: rgb(234 179 8);" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
    ...
    @else
        <button
            ...
            class="file-browser-item"
        >
            <svg width="16" height="16" style="color: rgb(156 163 175);" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
