        ...
        <div class="chat-header-controls">
            ...
            >
                ...
                <button
                    wire:click="deleteChat"
                    wire:confirm="Are you sure you want to delete this chat and all its messages? This cannot be undone."
                    class="inline-flex items-center gap-1 px-2 py-1 text-xs font-medium rounded bg-red-100 text-red-700 hover:bg-red-200 dark:bg-red-900/30 dark:text-red-300 dark:hover:bg-red-900/50 transition-colors"
