import { testExtractor, TestExtractorResult } from "./test-extractor.js";
...
export async function healthCheck(
  ...
  const results: ExtractorHealthResult[] = [];

  const testOne = async (name: string): Promise<ExtractorHealthResult> => {
...
export function getSampleUrls(): Record<string, string> {
  return { ...SAMPLE_URLS };
}

export function getDefaultExtractors(): string[] {
